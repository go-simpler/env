...
// It will be called by Load/LoadFrom if the WithUsageOnError option is provided
// and an error occurs while loading environment variables. It is exported as a
// variable, so it can be changed to a custom implementation.
